...
ALTER TABLE "РегистрОборот"
	ADD CONSTRAINT "РегистрОборо_2191" FOREIGN KEY ("ПриходДенег") REFERENCES "ПриходДенег" ("primaryKey");

CREATE INDEX "РегистрОборо_5235" on "РегистрОборот" ("ПриходДенег");

ALTER TABLE "РегистрОборот"
	ADD CONSTRAINT "РегистрОборо_6339" FOREIGN KEY ("РасходДенег") REFERENCES "РасходДенег" ("primaryKey");

CREATE INDEX "РегистрОборо_7822" on "РегистрОборот" ("РасходДенег");
