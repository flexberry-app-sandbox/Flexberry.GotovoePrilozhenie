...
namespace IIS.Gotovoe_prilozhenie
{
    ...
    [View("РегистрОборотE", new string[] {
            ...
            "ПриходДенег.РасходПриход as \'Расход/приход\'",
            "ПриходДенег.Тип as \'Тип\'",
            "ПриходДенег.Сумма as \'Сумма\'",
            "РасходДенег as \'Расход денег\'",
            "РасходДенег.ID as \'ID\'",
            "РасходДенег.Дата as \'Дата\'",
            "РасходДенег.РасходПриход as \'Расход/приход\'",
            "РасходДенег.Тип as \'Тип\'",
    ...
    public class РегистрОборот : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрОборотE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрОборотE", typeof(IIS.Gotovoe_prilozhenie.РегистрОборот));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистрОборотL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрОборотL", typeof(IIS.Gotovoe_prilozhenie.РегистрОборот));
                }
            }
        }
    }
