...
moduleForModel('i-i-s-gotovoe-prilozhenie-расход-денег', 'Unit | Serializer | i-i-s-gotovoe-prilozhenie-расход-денег', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gotovoe-prilozhenie-расход-денег',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
