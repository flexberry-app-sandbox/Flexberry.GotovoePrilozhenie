...
moduleForModel('i-i-s-gotovoe-prilozhenie-регистр-оборот', 'Unit | Serializer | i-i-s-gotovoe-prilozhenie-регистр-оборот', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gotovoe-prilozhenie-регистр-оборот',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
