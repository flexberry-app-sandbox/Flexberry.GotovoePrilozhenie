...
moduleForModel('i-i-s-gotovoe-prilozhenie-перечень-мат', 'Unit | Serializer | i-i-s-gotovoe-prilozhenie-перечень-мат', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gotovoe-prilozhenie-перечень-мат',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
