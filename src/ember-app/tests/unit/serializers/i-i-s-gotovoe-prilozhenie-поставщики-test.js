...
moduleForModel('i-i-s-gotovoe-prilozhenie-поставщики', 'Unit | Serializer | i-i-s-gotovoe-prilozhenie-поставщики', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gotovoe-prilozhenie-поставщики',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
