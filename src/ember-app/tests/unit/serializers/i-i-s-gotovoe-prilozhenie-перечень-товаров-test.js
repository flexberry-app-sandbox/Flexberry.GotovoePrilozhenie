...
moduleForModel('i-i-s-gotovoe-prilozhenie-перечень-товаров', 'Unit | Serializer | i-i-s-gotovoe-prilozhenie-перечень-товаров', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gotovoe-prilozhenie-перечень-товаров',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
